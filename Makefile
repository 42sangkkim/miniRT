...
#    Updated: 2023/01/12 00:54:33 by sangkkim         ###   ########seoul.kr   #
#                                                                              #
# **************************************************************************** #
...
SRCS := main.c \
			...
			init_scene/parse_util1.c init_scene/parse_util2.c \
...
$(NAME) : $(addprefix $(SRC_DIR)/, $(OBJS)) $(addprefix $(LIBFT_DIR)/, $(LIBFT))
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $^
